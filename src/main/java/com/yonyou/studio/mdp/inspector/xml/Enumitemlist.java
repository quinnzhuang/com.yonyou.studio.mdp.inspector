 ...
 *       &lt;sequence>
 *         &lt;element ref="{}enumitem" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "enumitemlist")
public class Enumitemlist {

    @XmlElement(required = true)
    protected List<Enumitem> enumitem;
     ...
     * 
     */
    public List<Enumitem> getEnumitem() {
        if (enumitem == null) {
            enumitem = new ArrayList<Enumitem>();
        }
